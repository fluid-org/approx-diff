...
set-indexed coproducts, the comparison reduces to the fibres over a common sort. Their carriers are
finite products of the same $F$-images, identified by tree recursion using $F$'s preservation of
products, and their predicate components agree by \lemref{conservativity:definable-coproducts} and
the closure operator's reindexing law (\lemref{conservativity:indexed-closure}).
\end{proof}
