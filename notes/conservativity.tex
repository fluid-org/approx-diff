...
coproducts by $F$ it makes $\GF$ preserve them: carriers by assumption, predicates by the lemma,
the coproducts of $\GLR(F)$ being computed as in \corref{conservativity:glr-poly}. In particular
