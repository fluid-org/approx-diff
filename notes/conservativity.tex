...
sort-wise using \lemref{conservativity:definable-coproducts} and the closure operator's reindexing
law (\lemref{conservativity:indexed-closure}), the realisation being computed as a set-indexed
coproduct in $\GLR(F)$.
\end{proof}
