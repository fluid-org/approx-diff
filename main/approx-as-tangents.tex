...
\subsection[Dependency Structures over Semirings]{\added{Dependency Structures over Semirings}}
...
the conjugate is thus meet-preserving, and is precisely the upper adjoint of $f$ (as it must be: upper adjoints
...
\end{definition}
\end{AddedBlock}
\Added{This is precisely the setting of \GPS~\cite{perera12a,perera16d,ricciotti17}, recovered here as the
...
\Added{The join-preserving and meet-preserving maps answer different questions. In the forwards direction, the
...
meet-preserving forward map was only used to establish the existence of the join-preserving backward map; it
seems to lack any direct applications in program slicing or dependency analysis.}
