...
reals sit, with the conjugate as the familiar adjoint of linear algebra; addition of real
numbers is not idempotent, and no order structure is available. Each further axiom on $S$ equips the analysis
with more structure.}
