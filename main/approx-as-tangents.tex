...
factors, with $\min$ and numerical $\times$; this presentation is isomorphic to the previous one under
logarithms, and the two are the classical dichotomy between absolute and relative
error~\cite{high:ASNA2}. Multiplication now has unit entries, since relative perturbations pass through a
