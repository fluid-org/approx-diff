...
\Added{In the refund example the amplification is $|3| / |3 + (-3)|$: division by zero, an infinite condition
...
their composite. The refund example of \secref{introduction:galois-slicing} exhibits exactly this: the price
