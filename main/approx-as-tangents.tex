...
analyses of work on linked visualisations~\cite{perera22,bond25}. These analyses work by composing a
join-preserving dependency analysis with its conjugate, yielding a map sending a selection of outputs to its
