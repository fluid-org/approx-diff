...
\subsubsection[Qualitative derivatives]{\added{Qualitative derivatives}}

\Added{The Boolean analysis reports a dependency at a cancellation because it forgets signs. The \emph{sign
...
\Added{Signed scalars also arise within provenance itself: negative multiplicities model deletion and
