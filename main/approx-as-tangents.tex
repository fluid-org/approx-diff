\section{Tangent Spaces as Semimodules}
...
the forward one alluded to in \secref{introduction}. Conjugation preserves identities, reverses
...
semimodules and linear maps form a dagger category $\SDSemiMod(S)$. A morphism is not
