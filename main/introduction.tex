...
product formula, with joins and meets in place of sums and products: $\langle x, y \rangle = 1$ exactly when
$x$ and $y$ overlap. The
forward map $f$ and backward map $g$ then determine one another by $\langle f(x), y \rangle = \langle x, g(y)
\rangle$.}{For \GPS, the forward and backward approximation maps are related by being a Galois connection. For differentiable programming, the forward and reverse derivatives are related by being each others' transpose.}
\end{itemize}
