...
as a Galois connection between lattices of approximations. \GPS will emerge as one instance of the
differential framework developed in this paper (\secref{approx-as-tangents}).}
