...
\begin{example}
  ...
  \end{displaymath}
  Like their numerical counterparts, these matrices compose: $\mathrm{total}\,l$ is a sum applied to per-row
  products applied to a selection, and the Jacobian of the run is the product of the Jacobians of those
  stages, a chain rule for dependencies. For the run with $l = \mathsf{a}$, the Boolean pipeline is
  \begin{displaymath}
