...
\roly{Now covered in Future Work.} Stable Domain Theory was originally proposed by \citet{berry79} as a refinement of domain theory aimed at
...
\Added{\todo{Write this section.} Negative multiplicities model deletion and update in the semiring
framework~\cite{green09}, and cancellation is the recognised obstruction to provenance for queries with
difference~\cite{amsterdamer11,geerts10}: the same failure of positivity that makes zero-testing lax in
\secref{approx-as-tangents:linearised-provenance}.}
...
the existence of reverse derivatives. \Deleted{In \conref{tangent-stable-fns} and \conref{tangent-fam}, we have
