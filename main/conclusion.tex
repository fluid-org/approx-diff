...
reveals new applications such as approximation by intervals~(\secref{interval-approx}). Our categorical
...
\roly{We can already do this, so perhaps this is more about applications.} Explainable AI (XAI) techniques
