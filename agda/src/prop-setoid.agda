...
module _ {o e} where
  ...
  -- The well-founded tree carrier of an IdxPoly. "W" follows Martin-Löf's
  -- W-type vocabulary (Martin-Löf 1984): the initial algebra of a polynomial
  -- functor, presented as the set of well-founded trees with shapes from
  -- IdxPoly. WSetoid/WFam package the same data with the appropriate
  -- equivalence / fibre structure.
  mutual
