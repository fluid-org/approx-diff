...
module Interp {o m e} {𝒞 : Category o m e}
  ...
  module _ {Γ : obj} where
    open Category (cat-ext Γ) public using ()
      renaming (assoc to assoc-co; ∘-cong to ∘-cong-co; ∘-cong₁ to ∘-cong-co₁; ∘-cong₂ to ∘-cong-co₂;
                id to id-co; id-left to id-left-co; id-right to id-right-co)
  ...
  iso-mor-fwd (const A≅B)     = A≅B .fwd ∘ p₂
  iso-mor-fwd var             = p₂
  iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) = s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂)
  iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂) = pair (iso-mor-fwd P₁≅Q₁ ∘co (p₁ ∘ p₂)) (iso-mor-fwd P₂≅Q₂ ∘co (p₂ ∘ p₂))

  iso-mor-fwd∘bwd : ∀ {P P'} (P≅P' : Poly-iso P P') {Γ X} →
                    iso-mor-fwd P≅P' {Γ} {X} ∘co iso-mor-fwd (iso-sym P≅P') ≈ id-co _
  ...
  iso-mor-fwd∘bwd (_+_ {P₁} {P₂} {Q₁} {Q₂} P₁≅Q₁ P₂≅Q₂) {Γ} {X} =
    ...
    where
      ...
      in₁-branch =
        begin
          (s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂) ∘co
           (s-copair (in₁ ∘ iso-mor-fwd (iso-sym P₁≅Q₁)) (in₂ ∘ iso-mor-fwd (iso-sym P₂≅Q₂)))) ∘co (in₁ ∘ p₂)
        ≈⟨ assoc-co _ _ _ ⟩
          s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂) ∘co
          (s-copair (in₁ ∘ iso-mor-fwd (iso-sym P₁≅Q₁)) (in₂ ∘ iso-mor-fwd (iso-sym P₂≅Q₂)) ∘co (in₁ ∘ p₂))
        ≈⟨ ∘-cong-co ≈-refl (s-copair-in₁ _ _) ⟩
          s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂) ∘co (in₁ ∘ iso-mor-fwd (iso-sym P₁≅Q₁))
        ≈˘⟨ ∘-cong₂ (≈-trans (pair-natural _ _ _)
              (pair-cong (pair-p₁ _ _) (≈-trans (assoc _ _ _) (∘-cong₂ (pair-p₂ _ _))))) ⟩
          s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂) ∘ (pair p₁ (in₁ ∘ p₂) ∘co (iso-mor-fwd (iso-sym P₁≅Q₁)))
        ≈˘⟨ assoc _ _ _ ⟩
          (s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂) ∘co (in₁ ∘ p₂)) ∘co (iso-mor-fwd (iso-sym P₁≅Q₁))
        ≈⟨ ∘-cong₁ (s-copair-in₁ _ _) ⟩
          (in₁ ∘ iso-mor-fwd P₁≅Q₁) ∘co (iso-mor-fwd (iso-sym P₁≅Q₁))
        ≈⟨ assoc _ _ _ ⟩
          in₁ ∘ (iso-mor-fwd P₁≅Q₁ ∘co (iso-mor-fwd (iso-sym P₁≅Q₁)))
      ...
      in₂-branch : (s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂) ∘co
                    (s-copair (in₁ ∘ iso-mor-fwd (iso-sym P₁≅Q₁)) (in₂ ∘ iso-mor-fwd (iso-sym P₂≅Q₂)))) ∘co (in₂ ∘ p₂)
                 ≈ p₂ ∘co (in₂ ∘ p₂)
      in₂-branch = begin
          (s-copair (in₁ ∘ iso-mor-fwd P₁≅Q₁) (in₂ ∘ iso-mor-fwd P₂≅Q₂) ∘co
  ...
  iso-mor-fwd∘bwd (_×_ {P₁} {P₂} {Q₁} {Q₂} P₁≅Q₁ P₂≅Q₂) {Γ} {X} =
    ...
    where
      pair-fwd = pair (iso-mor-fwd P₁≅Q₁ ∘co (p₁ ∘ p₂)) (iso-mor-fwd P₂≅Q₂ ∘co (p₂ ∘ p₂))
      pair-bwd = pair (iso-mor-fwd (iso-sym P₁≅Q₁) ∘co (p₁ ∘ p₂)) (iso-mor-fwd (iso-sym P₂≅Q₂) ∘co (p₂ ∘ p₂))
      ...
      p₁-branch = begin
        ...
        ≈˘⟨ assoc _ _ _ ⟩
          (p₁ ∘ pair-fwd) ∘co pair-bwd
        ≈⟨ ∘-cong₁ (pair-p₁ _ _) ⟩
          (iso-mor-fwd P₁≅Q₁ ∘co (p₁ ∘ p₂)) ∘co pair-bwd
        ≈⟨ assoc _ _ _ ⟩
          iso-mor-fwd P₁≅Q₁ ∘ (pair p₁ (p₁ ∘ p₂) ∘co pair-bwd)
        ≈⟨ ∘-cong₂ (≈-trans (pair-natural _ _ _)
                         (≈-trans (pair-cong (pair-p₁ _ _) (≈-trans (assoc _ _ _) (∘-cong₂ (pair-p₂ _ _))))
                                  (pair-cong₂ (pair-p₁ _ _)))) ⟩
          iso-mor-fwd P₁≅Q₁ ∘co (iso-mor-fwd (iso-sym P₁≅Q₁) ∘co (p₁ ∘ p₂))
        ≈˘⟨ ∘-cong₂ (≈-trans (pair-natural _ _ _) (pair-cong₁ (pair-p₁ _ _))) ⟩
          iso-mor-fwd P₁≅Q₁ ∘ (pair p₁ (iso-mor-fwd (iso-sym P₁≅Q₁)) ∘co (p₁ ∘ p₂))
        ≈˘⟨ assoc _ _ _ ⟩
          (iso-mor-fwd P₁≅Q₁ ∘co (iso-mor-fwd (iso-sym P₁≅Q₁))) ∘co (p₁ ∘ p₂)
        ≈⟨ ∘-cong₁ (iso-mor-fwd∘bwd P₁≅Q₁) ⟩
          p₂ ∘co (p₁ ∘ p₂)
  ...
  iso-mor-natural (_+_ {P₁} {P₂} {Q₁} {Q₂} P₁≅Q₁ P₂≅Q₂) f =
    ...
    ≈˘⟨ s-copair-ext _ ⟩
      s-copair ((iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co fmor (P₁ + P₂) f) ∘co (in₁ ∘ p₂))
               ((iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co fmor (P₁ + P₂) f) ∘co (in₂ ∘ p₂))
    ≈⟨ s-copair-cong eq-in₁ eq-in₂ ⟩
      s-copair ((fmor (Q₁ + Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂)) ∘co (in₁ ∘ p₂))
               ((fmor (Q₁ + Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂)) ∘co (in₂ ∘ p₂))
    ≈⟨ s-copair-ext _ ⟩
      fmor (Q₁ + Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂)
    ∎ where
      eq-in₁ : (iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co fmor (P₁ + P₂) f) ∘co (in₁ ∘ p₂)
               ≈ (fmor (Q₁ + Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂)) ∘co (in₁ ∘ p₂)
      eq-in₁ = begin
          (iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co fmor (P₁ + P₂) f) ∘co (in₁ ∘ p₂)
        ≈⟨ assoc-co _ _ _ ⟩
          iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co (fmor (P₁ + P₂) f ∘co (in₁ ∘ p₂))
        ≈⟨ ∘-cong-co ≈-refl (s-copair-in₁ _ _) ⟩
          iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co (in₁ ∘ fmor P₁ f)
        ≈˘⟨ ∘-cong-co ≈-refl (≈-trans (assoc _ _ _) (∘-cong₂ (pair-p₂ _ _))) ⟩
          iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co ((in₁ ∘ p₂) ∘co fmor P₁ f)
        ≈˘⟨ assoc-co _ _ _ ⟩
          (iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co (in₁ ∘ p₂)) ∘co fmor P₁ f
        ≈⟨ ∘-cong-co (s-copair-in₁ _ _) ≈-refl ⟩
          (in₁ ∘ iso-mor-fwd P₁≅Q₁) ∘co fmor P₁ f
        ≈⟨ assoc _ _ _ ⟩
          in₁ ∘ (iso-mor-fwd P₁≅Q₁ ∘co fmor P₁ f)
        ≈⟨ ∘-cong₂ (iso-mor-natural P₁≅Q₁ f) ⟩
          in₁ ∘ (fmor Q₁ f ∘co iso-mor-fwd P₁≅Q₁)
        ≈˘⟨ assoc _ _ _ ⟩
          (in₁ ∘ fmor Q₁ f) ∘co iso-mor-fwd P₁≅Q₁
        ≈˘⟨ ∘-cong-co (s-copair-in₁ _ _) ≈-refl ⟩
          (fmor (Q₁ + Q₂) f ∘co (in₁ ∘ p₂)) ∘co iso-mor-fwd P₁≅Q₁
        ≈⟨ assoc-co _ _ _ ⟩
          fmor (Q₁ + Q₂) f ∘co ((in₁ ∘ p₂) ∘co iso-mor-fwd P₁≅Q₁)
        ≈⟨ ∘-cong-co ≈-refl (≈-trans (assoc _ _ _) (∘-cong₂ (pair-p₂ _ _))) ⟩
          fmor (Q₁ + Q₂) f ∘co (in₁ ∘ iso-mor-fwd P₁≅Q₁)
        ≈˘⟨ ∘-cong-co ≈-refl (s-copair-in₁ _ _) ⟩
          fmor (Q₁ + Q₂) f ∘co (iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂) ∘co (in₁ ∘ p₂))
        ≈˘⟨ assoc-co _ _ _ ⟩
          (fmor (Q₁ + Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ + P₂≅Q₂)) ∘co (in₁ ∘ p₂)
  ...
  iso-mor-natural (_×_ {P₁} {P₂} {Q₁} {Q₂} P₁≅Q₁ P₂≅Q₂) f =
    ...
    ≈˘⟨ pair-ext _ ⟩
      pair (p₁ ∘ (iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂) ∘co fmor (P₁ × P₂) f))
           (p₂ ∘ (iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂) ∘co fmor (P₁ × P₂) f))
    ≈⟨ pair-cong eq-p₁ eq-p₂ ⟩
      pair (p₁ ∘ (fmor (Q₁ × Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂)))
           (p₂ ∘ (fmor (Q₁ × Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂)))
    ≈⟨ pair-ext _ ⟩
      fmor (Q₁ × Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂)
    ∎ where
      eq-p₁ : p₁ ∘ (iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂) ∘co fmor (P₁ × P₂) f)
              ≈ p₁ ∘ (fmor (Q₁ × Q₂) f ∘co iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂))
      eq-p₁ = begin
          p₁ ∘ (iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂) ∘co fmor (P₁ × P₂) f)
        ≈˘⟨ assoc _ _ _ ⟩
        ...
        ≈⟨ ∘-cong-co (pair-p₁ _ _) ≈-refl ⟩
          (iso-mor-fwd P₁≅Q₁ ∘co (p₁ ∘ p₂)) ∘co fmor (P₁ × P₂) f
        ≈⟨ assoc-co _ _ _ ⟩
          iso-mor-fwd P₁≅Q₁ ∘co ((p₁ ∘ p₂) ∘co fmor (P₁ × P₂) f)
        ≈⟨ ∘-cong-co ≈-refl (≈-trans (assoc _ _ _) (≈-trans (∘-cong₂ (pair-p₂ _ _)) (pair-p₁ _ _))) ⟩
          iso-mor-fwd P₁≅Q₁ ∘co (fmor P₁ f ∘co (p₁ ∘ p₂))
        ≈˘⟨ assoc-co _ _ _ ⟩
          (iso-mor-fwd P₁≅Q₁ ∘co fmor P₁ f) ∘co (p₁ ∘ p₂)
        ≈⟨ ∘-cong-co (iso-mor-natural P₁≅Q₁ f) ≈-refl ⟩
          (fmor Q₁ f ∘co iso-mor-fwd P₁≅Q₁) ∘co (p₁ ∘ p₂)
        ≈⟨ assoc-co _ _ _ ⟩
          fmor Q₁ f ∘co (iso-mor-fwd P₁≅Q₁ ∘co (p₁ ∘ p₂))
        ≈˘⟨ ∘-cong-co ≈-refl (≈-trans (assoc _ _ _) (≈-trans (∘-cong₂ (pair-p₂ _ _)) (pair-p₁ _ _))) ⟩
          fmor Q₁ f ∘co ((p₁ ∘ p₂) ∘co iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂))
        ≈˘⟨ assoc-co _ _ _ ⟩
          (fmor Q₁ f ∘co (p₁ ∘ p₂)) ∘co iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂)
        ≈˘⟨ ∘-cong-co (pair-p₁ _ _) ≈-refl ⟩
          (p₁ ∘ fmor (Q₁ × Q₂) f) ∘co iso-mor-fwd (P₁≅Q₁ × P₂≅Q₂)
  ...
  record HasMu : Set (o ⊔ m ⊔ e) where
    ...
    cata-inF : ∀ {Γ Q} → id-co {Γ} (μ Q) ≈ ⦅ inF Q ∘ p₂ ⦆
    ...
    fwd-cata-alg-mor {P} {P'} P≅P' =
      ...
      ≈˘⟨ assoc-co _ _ _ ⟩
        (⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆ ∘co (inF P ∘ p₂)) ∘co iso-mor-fwd (iso-sym P≅P')
      ≈⟨ ∘-cong-co₁ (⦅⦆-β _) ⟩
        ((inF P' ∘ iso-mor-fwd P≅P') ∘co fmor P ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆) ∘co iso-mor-fwd (iso-sym P≅P')
      ≈⟨ ∘-cong-co₁ (≈-trans (assoc _ _ _) (≈-sym (≈-trans (assoc _ _ _) (∘-cong₂ (pair-p₂ _ _))))) ⟩
        ((inF P' ∘ p₂) ∘co (iso-mor-fwd P≅P' ∘co fmor P ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆)) ∘co iso-mor-fwd (iso-sym P≅P')
      ≈⟨ ∘-cong-co₁ (∘-cong-co₂ (iso-mor-natural P≅P' _)) ⟩
        ((inF P' ∘ p₂) ∘co (fmor P' ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆ ∘co iso-mor-fwd P≅P')) ∘co iso-mor-fwd (iso-sym P≅P')
      ≈˘⟨ ∘-cong-co₁ (assoc-co _ _ _) ⟩
        (((inF P' ∘ p₂) ∘co fmor P' ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆) ∘co iso-mor-fwd P≅P') ∘co iso-mor-fwd (iso-sym P≅P')
      ≈⟨ assoc-co _ _ _ ⟩
        ((inF P' ∘ p₂) ∘co fmor P' ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆) ∘co (iso-mor-fwd P≅P' ∘co iso-mor-fwd (iso-sym P≅P'))
      ≈⟨ ∘-cong-co₂ (iso-mor-fwd∘bwd P≅P') ⟩
        ((inF P' ∘ p₂) ∘co fmor P' ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆) ∘co p₂
    ...
    iso-fwd∘bwd {P} {P'} P≅P' =
      ...
      ≈⟨ assoc _ _ _ ⟩
        ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆ ∘ (pair to-terminal (id (μ P))
          ∘ (⦅ inF P ∘ iso-mor-fwd (iso-sym P≅P') ⦆ ∘ pair to-terminal (id (μ P'))))
      ≈˘⟨ ∘-cong₂ (assoc _ _ _) ⟩
        ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆ ∘ ((pair to-terminal (id (μ P)) ∘ ⦅ inF P ∘ iso-mor-fwd (iso-sym P≅P') ⦆)
          ∘ pair to-terminal (id (μ P')))
      ≈⟨ ∘-cong₂ (∘-cong₁
           (≈-trans (pair-natural _ _ _) (pair-cong (to-terminal-unique _ _) id-left))) ⟩
        ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆ ∘ (pair to-terminal ⦅ inF P ∘ iso-mor-fwd (iso-sym P≅P') ⦆
          ∘ pair to-terminal (id (μ P')))
      ≈⟨ ∘-cong₂ (pair-natural _ _ _) ⟩
        ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆ ∘ pair (to-terminal ∘ pair to-terminal (id (μ P')))
                                          (⦅ inF P ∘ iso-mor-fwd (iso-sym P≅P') ⦆ ∘ pair to-terminal (id (μ P')))
      ≈⟨ ∘-cong₂ (pair-cong₁ (≈-trans (to-terminal-unique _ _) (≈-sym (pair-p₁ _ _)))) ⟩
        ⦅ inF P' ∘ iso-mor-fwd P≅P' ⦆ ∘ pair (p₁ ∘ pair to-terminal (id (μ P')))
                                          (⦅ inF P ∘ iso-mor-fwd (iso-sym P≅P') ⦆ ∘ pair to-terminal (id (μ P')))
      ≈˘⟨ ∘-cong₂ (pair-natural _ _ _) ⟩
    ...
    iso {P} {P'} P≅P' .bwd∘fwd≈id =
      substP (λ q → (⦅ inF P ∘ iso-mor-fwd (iso-sym P≅P') ⦆ ∘ pair to-terminal (id _))
                       ∘ (⦅ inF P' ∘ iso-mor-fwd q ⦆ ∘ pair to-terminal (id _)) ≈ id (μ P))
