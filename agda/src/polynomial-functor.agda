      ...
      where
        ...
        in₁-branch =
          ...
          ≈˘⟨ ∘-cong ≈-refl
            ...
            scopair (in₁ ∘ poly-iso-mor pi₁) (in₂ ∘ poly-iso-mor pi₂) ∘ (pair p₁ (in₁ ∘ p₂) ∘ pair p₁ (poly-iso-mor (Poly-iso-sym pi₁)))
          ≈˘⟨ assoc _ _ _ ⟩
            (scopair (in₁ ∘ poly-iso-mor pi₁) (in₂ ∘ poly-iso-mor pi₂) ∘ pair p₁ (in₁ ∘ p₂)) ∘ pair p₁ (poly-iso-mor (Poly-iso-sym pi₁))
          ≈⟨ ∘-cong (scopair-in₁ _ _) ≈-refl ⟩
            (in₁ ∘ poly-iso-mor pi₁) ∘ pair p₁ (poly-iso-mor (Poly-iso-sym pi₁))
          ≈⟨ assoc _ _ _ ⟩
            in₁ ∘ (poly-iso-mor pi₁ ∘ pair p₁ (poly-iso-mor (Poly-iso-sym pi₁)))
          ≈⟨ ∘-cong ≈-refl (poly-iso-mor-fwd∘bwd pi₁) ⟩
            in₁ ∘ p₂
          ≈˘⟨ pair-p₂ _ _ ⟩
            p₂ ∘ pair p₁ (in₁ ∘ p₂)
      ...
      where
        ...
        p₁-branch = begin
          ...
          ≈⟨ assoc _ _ _ ⟩
            poly-iso-mor pi₁ ∘ (pair p₁ (p₁ ∘ p₂) ∘ pair p₁ pair-bwd)
          ≈⟨ ∘-cong ≈-refl (pair-natural _ _ _) ⟩
            poly-iso-mor pi₁ ∘ pair (p₁ ∘ pair p₁ pair-bwd) ((p₁ ∘ p₂) ∘ pair p₁ pair-bwd)
          ≈⟨ ∘-cong ≈-refl (pair-cong (pair-p₁ _ _) (≈-trans (assoc _ _ _) (∘-cong ≈-refl (pair-p₂ _ _)))) ⟩
