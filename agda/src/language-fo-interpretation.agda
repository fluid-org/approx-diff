...
open import categories using (Category; HasTerminal; HasProducts; HasCoproducts; HasExponentials; HasBooleans; coproducts+exp→booleans; HasLists; Poly; HasMu)
...
module language-fo-interpretation {ℓ} (Sig : Signature ℓ)
  ...
  (𝒟 : Category o₂ m₂ e₂) (𝒟T : HasTerminal 𝒟) (𝒟P : HasProducts 𝒟) (𝒟CP : HasCoproducts 𝒟) (𝒟E : HasExponentials 𝒟 𝒟P) (𝒟L : HasLists 𝒟 𝒟T 𝒟P) (𝒟HM : ∀ Q → HasMu 𝒟 𝒟T 𝒟P 𝒟CP Q)
  (F : Functor 𝒞 𝒟)
...
open import language-interpretation Sig 𝒟 𝒟T 𝒟P 𝒟CP 𝒟E 𝒟L 𝒟HM 𝒟-Sig-model
