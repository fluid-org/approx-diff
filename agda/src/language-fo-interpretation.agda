...
module language-fo-interpretation {ℓ} (Sig : Signature ℓ)
  ...
  (𝒟𝟙ty : Category.obj 𝒟)
  (𝒟unit-pt : Category._⇒_ 𝒟 (HasTerminal.witness 𝒟T) 𝒟𝟙ty)
  (F : Functor 𝒞 𝒟)
  ...
  (F𝟙ty : Category.Iso 𝒟 (F .fobj 𝒞𝟙ty) 𝒟𝟙ty)
  (𝒞-Sig-model : Model PFPC[ 𝒞 , 𝒞T , 𝒞P ,
                  HasCoproducts.coprod (strong-coproducts→coproducts 𝒞T 𝒞SC) 𝒞𝟙ty 𝒞𝟙ty ] Sig)
  where
...
fo-poly-iso unit          δ𝒞 δ𝒟 es = PM.pm-iso-const F𝟙ty
