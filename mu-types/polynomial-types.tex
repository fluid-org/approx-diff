...
$\mu$-body whose constants are index sets, and an \emph{assignment} $\rho$ taking each free
variable to either a parameter in $\Delta$ or another sort. The collection of sorts is inductively
