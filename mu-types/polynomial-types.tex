...
\noindent
\Added{Unfolding $\circ_\Gamma$, the initiality square commutes in the underlying category as}
\begin{AddedBlock}
\begin{center}
...
\end{AddedBlock}
\noindent
\Added{where the left edge duplicates the context, retaining $\Gamma$ for $a$ while also feeding it
