...
% Combined helpers: inline markup + a margin changebar. Use the bare \added/\deleted/\replaced
% (no bar) inside figures or math, where changebar spans can misbehave.
\newcommand{\ins}[1]{\protect\cbstart\added{#1}\protect\cbend}
\newcommand{\del}[1]{\protect\cbstart\deleted{#1}\protect\cbend}
\newcommand{\repl}[2]{\protect\cbstart\replaced{#1}{#2}\protect\cbend}
