...
% Deleted text in grey, whoever the author. Smash the strikeout so its box
% adds no height/depth, otherwise ulem inflates the interline spacing.
\setdeletedmarkup{\textcolor{gray}{\smash{\sout{#1}}}}
