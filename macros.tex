...
\newcommand{\Added}[1]{\protect\cbstart\added{#1}\protect\cbend}
\newcommand{\Deleted}[1]{\protect\cbstart\deleted{#1}\protect\cbend}
\newcommand{\Replaced}[2]{\protect\cbstart\replaced{#1}{#2}\protect\cbend}
