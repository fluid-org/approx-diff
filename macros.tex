...
\newcommand{\Added}[1]{\protect\cbstart\added{#1}\protect\cbend\xspace}
...
\newcommand{\Deleted}[1]{\protect\cbstart{\cmRobustCites\deleted{#1}}\protect\cbend\xspace}
\newcommand{\Replaced}[2]{\protect\cbstart{\cmRobustCites\replaced{#1}{#2}}\protect\cbend\xspace}
