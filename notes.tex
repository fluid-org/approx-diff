...
\noindent Inductive types from polynomial endofunctors, and the conservativity development that
depends on them (predicate systems, glueing, syntactic definability), previously covered here, now
have their own document (\texttt{mu-types.pdf}).
