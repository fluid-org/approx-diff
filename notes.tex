...
\item slicing interpretation of the source language via a strong monad on the semantic category (\secref{slicing-interpretation})
\end{itemize}
...
\input{notes/slicing-interpretation}
