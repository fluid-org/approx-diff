...
\noindent Inductive types from polynomial endofunctors, and the correctness development that
depends on them (predicate systems, glueing, agreement of the underlying interpretation),
previously covered here, now have their own document (\texttt{mu-types.pdf}).
