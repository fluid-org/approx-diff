...
\usepackage{tikz-cd}
\usepackage{xspace}
% \finalmode (set by main-final.tex) renders the clean version: deletions dropped, no margin bars.
\ifdefined\finalmode
...
\fi
\usepackage{changebar}    % margin bars marking changed regions
\ifdefined\finalmode\nochangebars\fi
...
\title{\Replaced{Data Provenance as}{Galois Slicing as} Automatic Differentiation}
